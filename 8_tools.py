...
# we are using a computer tool to search the web 
# this is copy paste from openai examples
...
async def main():
    async with LocalPlaywrightComputer() as computer:
        with trace("Computer use example"):
            ...
            result = await Runner.run(agent, "Search for most interesting things to do in Warsaw this weekend.")
